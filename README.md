...
* адрес картинки
* :heavy_exclamation_mark: всегда требуется использовать строго квадратные картинки, при использовании картинки с неровными пропорциями при наведении картинка будет "дёргаться"
